(function() {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.ll-nav-btn{background:var(--bg-tertiary,#21262d);color:var(--text-secondary,#c9d1d9);border:1px solid var(--border-primary,#30363d);padding:0.3rem 0.7rem;border-radius:6px;cursor:pointer;font-size:0.85rem;transition:all 0.15s;display:inline-flex;align-items:center;gap:0.3rem;font-family:inherit}',
      '.ll-nav-btn:hover{border-color:var(--accent-blue,#58a6ff);color:var(--text-primary,#f0f6fc);background:var(--accent-blue-dim,#1f6feb20)}',
      '.ll-nav-btn-primary{background:var(--accent-green,#238636);border-color:var(--accent-green,#238636);color:#fff}',
      '.ll-nav-btn-primary:hover{background:var(--accent-green-hover,#2ea043);border-color:var(--accent-green-hover,#2ea043)}',
      ...
      '.ll-modal{background:var(--bg-secondary,#161b22);border:1px solid var(--border-primary,#30363d);border-radius:12px;width:90%;max-width:560px;max-height:85vh;overflow-y:auto;box-shadow:0 8px 32px var(--shadow,rgba(0,0,0,0.4))}',
      '.ll-modal-header{padding:1rem 1.25rem;border-bottom:1px solid var(--border-primary,#30363d);display:flex;justify-content:space-between;align-items:center}',
      '.ll-modal-header h2{color:var(--text-primary,#f0f6fc);font-size:1.1rem;margin:0}',
      '.ll-modal-close{background:none;border:none;color:var(--text-muted,#8b949e);font-size:1.5rem;cursor:pointer;padding:0.25rem;line-height:1}',
      '.ll-modal-close:hover{color:var(--text-primary,#f0f6fc)}',
      '.ll-modal-body{padding:1.25rem}',
      '.ll-tabs{display:flex;gap:0;border-bottom:1px solid var(--border-primary,#30363d);padding:0 1.25rem;overflow-x:auto}',
      '.ll-tab{padding:0.6rem 0.85rem;color:var(--text-muted,#8b949e);cursor:pointer;font-size:0.85rem;border-bottom:2px solid transparent;transition:all 0.15s;white-space:nowrap;background:none;border-top:none;border-left:none;border-right:none;font-family:inherit}',
      '.ll-tab:hover{color:var(--text-secondary,#c9d1d9)}',
      '.ll-tab.active{color:var(--text-primary,#f0f6fc);border-bottom-color:var(--accent-orange,#f78166)}',
      '.ll-form-group{margin-bottom:1rem}',
      '.ll-form-group label{display:block;font-size:0.85rem;color:var(--text-secondary,#c9d1d9);margin-bottom:0.35rem;font-weight:500}',
      '.ll-hint{font-size:0.75rem;color:var(--text-muted,#8b949e);margin-bottom:0.35rem}',
      '.ll-input,.ll-textarea,.ll-select{width:100%;background:var(--bg-input,#0d1117);color:var(--text-secondary,#c9d1d9);border:1px solid var(--border-primary,#30363d);border-radius:6px;padding:0.5rem 0.75rem;font-size:0.9rem;font-family:inherit;transition:border-color 0.15s}',
      '.ll-input:focus,.ll-textarea:focus,.ll-select:focus{border-color:var(--accent-blue,#58a6ff);outline:none;box-shadow:0 0 0 3px var(--accent-blue-dim,#1f6feb30)}',
      ...
      '.ll-btn-submit{background:var(--accent-green,#238636);color:#fff;border-color:var(--accent-green,#238636)}',
      '.ll-btn-submit:hover{background:var(--accent-green-hover,#2ea043)}',
      '.ll-btn-submit:disabled{opacity:0.5;cursor:not-allowed}',
      '.ll-btn-cancel{background:var(--bg-tertiary,#21262d);color:var(--text-secondary,#c9d1d9);border-color:var(--border-primary,#30363d)}',
      '.ll-btn-cancel:hover{border-color:var(--text-muted,#8b949e)}',
      '.ll-form-actions{display:flex;gap:0.75rem;justify-content:flex-end;margin-top:1.25rem;padding-top:1rem;border-top:1px solid var(--border-secondary,#21262d)}',
      '.ll-toast{position:fixed;bottom:1.5rem;right:1.5rem;padding:0.75rem 1.25rem;border-radius:8px;font-size:0.9rem;z-index:2000;max-width:420px;animation:ll-fadein 0.3s ease;box-shadow:0 4px 12px var(--shadow,rgba(0,0,0,0.3))}',
      '.ll-toast-success{background:var(--accent-green,#238636);color:#fff;border:1px solid var(--accent-green-hover,#2ea043)}',
      '.ll-toast-error{background:var(--accent-red,#da3633);color:#fff;border:1px solid var(--accent-red,#f85149)}',
      '.ll-toast-info{background:var(--accent-blue-bg,#1f6feb);color:#fff;border:1px solid var(--accent-blue,#388bfd)}',
      ...
      '.ll-token-toggle{background:none;border:1px solid var(--border-primary,#30363d);color:var(--text-muted,#8b949e);border-radius:4px;padding:0.15rem 0.4rem;cursor:pointer;font-size:0.75rem;margin-left:0.5rem}',
      '.ll-token-toggle:hover{color:var(--text-secondary,#c9d1d9);border-color:var(--text-muted,#8b949e)}',
